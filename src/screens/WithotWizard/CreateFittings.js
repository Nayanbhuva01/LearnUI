...
export default function CreateFittings({navigation}) {
  ...
  return (
    <WithBackground>
      <ScrollView
        ...
        <Button
          BtnName="Save Fitting"
          onPress={() => navigation.navigate('SavedFittings')}
        />

        <TouchableOpacity
          style={styles.ContinueBtn}
          onPress={() => navigation.navigate('S1FittingWizard')}>
          <Text style={[styles.ContinueTxt, CustomFont.Roboto_Reg]}>
            Continue with Wizzard
          </Text>
        </TouchableOpacity>
      </ScrollView>
    </WithBackground>
